...
export default async function LoginPage() {
  ...
  return (
    <div className="relative min-h-svh flex flex-col lg:flex-row bg-[#030712] text-foreground overflow-hidden">
      ...
      {/* ── RIGHT: Login Form ───────────────────────────── */}
      <section className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-10 lg:px-12 lg:py-0 lg:bg-[#030712]">
        {/* Subtle left edge accent on desktop */}
        <div className="hidden lg:block absolute inset-y-0 left-0 w-px bg-gradient-to-b from-transparent via-white/[0.06] to-transparent" />
